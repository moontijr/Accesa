...
/**
 * a UI class, that will make a console application view, for the user
 */
public class UI {
    ...
    /**
     * the start menu for the application
     */
    ...
    /**
     * the menu after you are logged in as a user
    ...
    public void userMenu(User user) {
        ...
        try {
            ...
            switch (choice) {
                ...
                case 4 -> { //you can create quests only if you have over 100 tokens
                    if (user.getNumberTokens() < 100 ) {
                        System.out.println("Not enough tokens for you to be able to make a new Quest");
                        this.userMenu(user);
                    } else {
                        this.userInput.nextLine();
